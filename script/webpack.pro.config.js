...
const config = {
    ...
    module: {
        loaders: [{
            ...
            loader: ExtractTextPlugin.extract('style-loader', 'css-loader?modules&camelCase&localIdentName=[hash:base64:16]&importLoaders=1!stylus-loader')
        }, {
            test: /\.styl$/,

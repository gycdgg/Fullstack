      ...
      <div className  = {styles.desc__content}>
        ...
        <div className = {styles.desc__content__text}>
          ...
          <div className = {styles.desc__content__text__pdf}>
            <Icon type="file-pdf" className = {styles.pdfIcon}/><span className = {styles.pdfSpan}>testPDF</span> <Button type="primary" icon="download" size = "small" ghost className = {styles.pdfSpan}>Download</Button>
          </div>
          <hr/>
